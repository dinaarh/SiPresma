<div class="bg-gray-100 flex flex-row justify-between items-center rounded-xl px-4 py-4">
    ...
    <div class="flex items-center space-x-3">
        <button type="button"
            class="text-primary bg-white hover:bg-blue-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-lg p-2.5 text-center inline-flex items-center ">
